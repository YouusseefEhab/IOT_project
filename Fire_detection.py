...
st.innerText=d.alert?'🔥 DANGER':'✅ SAFE'
st.className='status '+(d.alert?'danger':'safe')
})
},1000)
</script>
</head>
...
<div class="container">
    ...
    <div class="row">
        <div class="card">
            <h2>🌡 Temperature</h2>
            <div id="t" class="value">0</div>
        </div>

        <div class="card">
            <h2>💨 Smoke</h2>
            <div id="s" class="value">0</div>
        </div>

        <div class="card">
            <h2>🔥 Flame</h2>
            <div id="f" class="value">NO</div>
        </div>

        <div class="card">
            <h2>🤖 AI Risk</h2>
            <div id="r" class="value">0</div>
        </div>
    </div>
